...
void loop() {
  ...
  Serial.print('c' + String(ppmCO));
  Serial.print('s' + String(ppmSmoke));
  delay(2000);
  if ((ppmLPG < ppmLPGLimit) && (ppmCO < ppmCOLimit) && (ppmSmoke < ppmSmokeLimit))
     { 
